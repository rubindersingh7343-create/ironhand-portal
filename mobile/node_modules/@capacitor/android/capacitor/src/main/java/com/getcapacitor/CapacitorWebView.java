...
public class CapacitorWebView extends WebView {
    ...
    public void edgeToEdgeHandler(Bridge bridge) {
        ...
        final int ANDROID_15_API = 35;

        if (Build.VERSION.SDK_INT >= ANDROID_15_API && configEdgeToEdge.equals("auto")) {
            TypedValue value = new TypedValue();
            int edgeOptOutAttr = getContext()
                .getResources()
                .getIdentifier("windowOptOutEdgeToEdgeEnforcement", "attr", "android");
            boolean foundOptOut =
                edgeOptOutAttr != 0 && getContext().getTheme().resolveAttribute(edgeOptOutAttr, value, true);
